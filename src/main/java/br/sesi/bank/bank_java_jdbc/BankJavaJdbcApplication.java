...
public class BankJavaController {
	...
	public BankJavaController(){
		 this.service = new ContaService()
			this.teclado = new Scanner(System.in).useDelimiter(pattern: "\n");
	}
	public static void main (String[] args) throws SQLException {
		BankJavaController controller = new Scanner(System.in).useDelimiter(pattern: "\n");
		...
		while (opcao != 8) {
			try {
				...
				System.out.println("Pressione qualquer tecla e de ENTER para voltar");
				teclado.next();
			}
			opcao = exibirMenu();
		}
	...
	private void realizarTransferencia() {
		...
		System.out.println("Digite o numero de conta de DESTINO");
